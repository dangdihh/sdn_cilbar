            ...
            <div class="relative flex justify-center lg:justify-end" data-aos="fade-left" data-aos-duration="900">
                ...
                <div id="hero-img" class="hero-img-wrap relative w-full max-w-lg cursor-none">
                    <div class="img-zoom rounded-3xl overflow-hidden border-[5px] border-white shadow-2xl shadow-[#1A8DA3]/20 relative z-10">
                        <img src="https://oxpfyxpdfitdzsnftngj.supabase.co/storage/v1/object/public/fotocilbar/foto%20homn_result.webp" alt="SDN Ciledug Barat" class="w-full h-80 md:h-96 object-cover">
                    </div>
        ...
        <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="space-y-6" data-aos="fade-right" data-aos-duration="800">
                    ...
                    <h2 class="font-headline text-3xl md:text-4xl font-bold text-gray-900 leading-tight section-title-bar">
                        Mengapa <span class="text-[#1A8DA3]">SDN Ciledug Barat?</span>
                    </h2>

                    <p class="text-gray-500 leading-relaxed text-sm md:text-base max-w-md">
                        Kami hadir bukan sekadar sekolah — tapi partner tumbuh kembang anak Anda. Ini yang membedakan kami dari yang lain.
                    </p>

                    <a href="/tentang" class="btn-ripple group inline-flex items-center gap-2 px-7 py-3.5 rounded-full bg-[#1A8DA3] text-white font-semibold text-sm shadow-lg shadow-[#1A8DA3]/30 hover:bg-[#157a8e] hover:scale-105 transition-all duration-300 w-fit">
                ...
                {{-- Kanan: 4 Kartu Keunggulan --}}
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5" data-aos="fade-left" data-aos-duration="800">

                    @php
                    $keunggulan = [
                        [
                            'icon'  => 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253',
                            'title' => 'Kurikulum Berkarakter',
                            'desc'  => 'Tidak hanya fokus pada nilai akademik, tapi juga pembentukan akhlak mulia dan kemandirian siswa sejak dini.',
                            'bg'    => 'bg-[#e0f6fa]',
                            'color' => 'text-[#1A8DA3]',
                        ],
                        [
                            ...
                            'desc'  => 'Mendukung minat dan bakat anak melalui 6+ pilihan ekstrakurikuler unggulan yang terstruktur dan menyenangkan.',
                            'bg'    => 'bg-[#FFF9C4]',
                            'color' => 'text-yellow-600',
                        ],
                        [
                            'icon'  => 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z',
                            'title' => 'Lingkungan Aman & Inovatif',
                            'desc'  => 'Sekolah berakreditasi A dengan ekosistem belajar yang inklusif, aman, dan mendorong kreativitas anak.',
                            'bg'    => 'bg-purple-50',
                            'color' => 'text-purple-600',
                        ],
                        [
                            'icon'  => 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z',
                            'title' => 'Guru Kompeten & Berdedikasi',
                            'desc'  => '18 tenaga pendidik berpengalaman yang siap membimbing setiap siswa dengan pendekatan personal dan penuh kasih.',
                            'bg'    => 'bg-green-50',
                    ...
                    <div class="group rounded-2xl border border-gray-100 bg-white p-5 shadow-sm hover:border-[#1A8DA3]/40 hover:shadow-md hover:-translate-y-1 transition-all duration-300"
                        data-aos="fade-up" data-aos-delay="{{ $i * 80 }}">
                        <div class="w-11 h-11 rounded-xl {{ $item['bg'] }} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
        ...
        <div class="max-w-7xl mx-auto">
            ...
            $kategoriArtikel = [
                [
                    ...
                    'bg_image'    => 'https://oxpfyxpdfitdzsnftngj.supabase.co/storage/v1/object/public/fotoguru/eskul_result.webp',
                ],
                [
                    'label'       => 'Prestasi',
                    ...
                    'bg_image'    => 'https://oxpfyxpdfitdzsnftngj.supabase.co/storage/v1/object/public/fotocilbar/SnapInsta.to_631224706_18327305305220306_794057659458322469_n%20(1)_result.webp',
                ],
                [
                    'label'       => 'Dokumentasi',
                    ...
                    'bg_image'    => 'https://oxpfyxpdfitdzsnftngj.supabase.co/storage/v1/object/public/fotocilbar/dokumentasin_result.webp',
                ],
            ];
            @endphp
