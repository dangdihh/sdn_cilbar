<x-layout>
    ...
    <div class="bg-[#F8F9FA] min-h-screen font-body text-slate-700 antialiased pb-20">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div class="lg:col-span-7 space-y-6">
                    ...
                    <div class="flex flex-wrap gap-4 pt-2">
                        ...
                        {{-- Tombol Cek Status --}}
                        <a href="{{ route('ppdb.cek-status') }}" class="px-6 py-3 bg-white hover:bg-slate-50 text-[#1A8DA2] border border-slate-200 text-xs font-bold rounded-full transition-all duration-200 shadow-xs">
        ...
        <section id="formulir" class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="bg-gradient-to-br from-[#1A8DA2] to-[#167688] text-white rounded-[2.5rem] p-8 md:p-16 text-center space-y-6 shadow-xl relative overflow-hidden">
                ...
                <div class="pt-2">
                    <a href="{{ route('ppdb.formulir') }}" class="inline-flex items-center gap-2 px-8 py-4 bg-white hover:bg-slate-50 text-[#1A8DA2] text-xs font-bold rounded-full shadow-lg transition-all duration-200 transform hover:-translate-y-0.5">
